...
namespace MiniCarLib.Core
{
    public class TCPDriver : IComDriver
    {
        ...
        {
            CarTCPClient carclient = client as CarTCPClient;
        ...
        private void HandleAsyncConnection(IAsyncResult res)
        {
            ...
            if (client != null)
            {
                ...
                CarTCPClient carclient = new CarTCPClient(client);
